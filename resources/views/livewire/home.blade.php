                            ...
                            <div class="bg-gray-800 border border-gray-800 shadow-lg  rounded-2xl p-4">
                                <div class="flex-none sm:flex">
                                    <div class=" relative h-32 w-32   sm:mb-0 ">
                                        <img src="images/profile.jpg" alt="aji"
                                    ...
                                    <div class="flex-auto sm:ml-5 justify-evenly">
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex flex-col">
                                                    <div
                                                        ...
                                                        Sabaa Al-Shamery</div>
                                                    <div class="flex-auto text-gray-400 my-1">
                                                        <span class="mr-3 ">Web Developer</span><span
                                                            class="mr-3 border-r border-gray-600  max-h-0"></span><span>Desginer</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex flex-row items-center">
                                            ...
                                            <div class="flex-1 inline-flex   items-center ml-2 space-x-2">
                                                <a hre="https://www.behance.net/ajeeshmon" target="_blank"><svg
                                                        class=" cursor-pointer w-5 h-5 p-1  rounded-2xl hover:bg-green-500 hover:text-white transition ease-in duration-300"
                                                ...
                                                <a hre="https://twitter.com/ajeemon?lang=en" target="_blank"><svg
                                                        class="cursor-pointer w-5 h-5 p-1  rounded-2xl hover:bg-green-400 hover:text-white transition ease-in duration-300"
                                        ...
                                        <div class="flex pt-2  text-sm text-gray-400">
                                            ...
                                            <div class="flex-1 inline-flex items-center">
                                                ...
                                                <p class="">14 Websites</p>
                                            </div>
                                            <a href="https://www.behance.net/ajeeshmon" target="_blank"
                                                class="relative flex-no-shrink border border-1 rounded-2xl px-5 ml-4 py-2 text-xs shadow-sm hover:nounderline">
                                                <div class="inline-flex ">
                                                    <p>Follow</p>
                                                    <span
                                                        class="animate-ping absolute -top-1 right-3 w-2 h-2 inline-flex border-2 rounded-2xl border-green-400 opacity-75"></span>
                                                    <span class=" "></span>
                                                </div>

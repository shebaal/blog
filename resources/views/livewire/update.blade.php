    ...
    <div
        ...
        <div class="p-3  mt-2 text-center space-x-4 md:block">
            ...
            <button wire:click.prevent="update()"
                class="bg-green-400 hover:bg-green-500 px-5 ml-4 py-2 text-sm shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-green-300 hover:border-green-500 text-white rounded-full transition ease-in duration-300">Update</button>
        </div>
    </div>
    </div>
</form>
